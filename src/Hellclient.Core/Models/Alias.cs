...
public class Alias
{
    const int AliasFlagEnabled = 1;
    const int AliasFlagKeepEvaluating = 8;
    const int AliasFlagIgnoreAliasCase = 32;
    const int AliasFlagOmitFromLogFile = 64;
    const int AliasFlagRegularExpression = 128;
    const int AliasFlagExpandVariables = 512;
    const int AliasFlagReplace = 1024;
    const int AliasFlagAliasSpeedWalk = 2048;
    const int AliasFlagAliasQueue = 4096;
    const int AliasFlagAliasMenu = 8192;
    const int AliasFlagTemporary = 16384;
