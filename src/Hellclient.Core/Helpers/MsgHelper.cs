...
public class MsgHelper
{
    ...
    public const string MsgTypeScriptTypes = "scriptTypes";
    ...
    public static void PublishScriptTypesMessage(IPublisher p, List<ScriptType> types)
    {
        p.Publish(new Message(MsgTypeScriptTypes, "", types));
    }
